...
#define LINPHONE_IOS_VERSION "3.16.5-66-ge4a4232c"
...
- (LinphoneCall *)callByUsername:(NSString *)username {
    ...
    LinphoneAddress* linphoneAddress = linphone_core_interpret_url([LinphoneManager getLc], [username cStringUsingEncoding:[NSString defaultCStringEncoding]]);
    if (linphoneAddress == NULL) {
        return NULL;
    }
    LinphoneCall *call = linphone_core_invite_address(theLinphoneCore, linphoneAddress);
    return call;
}
